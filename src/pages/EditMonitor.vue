                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <template v-if="monitor.type === 'http' || monitor.type === 'keyword' || monitor.type === 'json-query' || monitor.type === 'grpc-keyword' ">
                                ...
                                <div class="my-3 form-check">
                                    <input id="check-content-parameter" v-model="monitor.check_content_parameter" class="form-check-input" type="checkbox">
                                    <label class="form-check-label" for="check-content-parameter">
                                        {{ $t("Check Content Parameter") }}
                                    </label>
                                    <div class="form-text">
                                        {{ $t("checkContentParameterDescription") }}
                                    </div>
                                </div>
                            </template>
